...
QWidget* MainWindowAboutPage::createPage(QWidget* parent) const {
    ...
    label_shortcut->setText(QObject::tr("Shotcut key"));
    ...
    label_fullscreen_name->setText(QObject::tr("Switch Fullscreen"));
    ...
    label_mouse_mode_name->setText(QObject::tr("Mouse mode"));
    ...
    label_about->setText(QObject::tr("Lanthing"));
    about_layout->addWidget(label_about);

    auto* label_about_content = new QLabel(frame_about);
    label_about_content->setText(
        QObject::tr("<html><head/><body><p>Lanthing is a remote control tool created by "
