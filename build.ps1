...
function rtc_fetch() {
    $RtcUri = "https://github.com/numbaa/rtc-prebuilt/releases/download/v0.7.8/rtc.win.zip"
...
function prebuilt_fetch() {
    $libs = @(
        ...
        [BuiltLib]::new("nbclipboard", "https://github.com/numbaa/nbclipboard-prebuilt/releases/download/v0.0.1/nbclipboard.win.v0.0.2.zip")
    )
