...
std::unique_ptr<VideoEncoder> VideoEncoder::do_create_encoder(const InitParams& params, void* d3d11_dev, void* d3d11_ctx)
{
...
std::vector<VideoEncoder::Ability> VideoEncoder::check_encode_abilities(uint32_t width, uint32_t height)
{
