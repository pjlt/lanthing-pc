...
private:
    void send_message_to_host(uint32_t type, const std::shared_ptr<google::protobuf::MessageLite>& msg, bool reliable);
...
void InputImpl::init()
{
    sdl_->set_input_handler(std::bind(&InputImpl::on_platform_input_event, this, std::placeholders::_1));
}

void InputImpl::send_message_to_host(uint32_t type, const std::shared_ptr<google::protobuf::MessageLite>& msg, bool reliable)
{
...
void InputImpl::handle_mouse_button(const MouseButtonEvent& ev)
{
    ...
    case MouseButtonEvent::Button::Left:
        key_flag = ev.is_pressed ? ltproto::peer2peer::MouseClick_KeyFlag_LeftDown : ltproto::peer2peer::MouseClick_KeyFlag_LeftUp;
        break;
    case MouseButtonEvent::Button::Mid:
        key_flag = ev.is_pressed ? ltproto::peer2peer::MouseClick_KeyFlag_MidDown : ltproto::peer2peer::MouseClick_KeyFlag_MidUp;
        break;
    case MouseButtonEvent::Button::Right:
        key_flag = ev.is_pressed ? ltproto::peer2peer::MouseClick_KeyFlag_RightDown : ltproto::peer2peer::MouseClick_KeyFlag_RightUp;
        break;
    case MouseButtonEvent::Button::X1:
        key_flag = ev.is_pressed ? ltproto::peer2peer::MouseClick_KeyFlag_X1Down : ltproto::peer2peer::MouseClick_KeyFlag_X1Up;
        break;
    case MouseButtonEvent::Button::X2:
        key_flag = ev.is_pressed ? ltproto::peer2peer::MouseClick_KeyFlag_X2Down : ltproto::peer2peer::MouseClick_KeyFlag_X2Up;
        break;
    default:
